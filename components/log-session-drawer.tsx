    ...
    <Drawer.Root open={open} onOpenChange={(o) => !o && handleClose()}>
      <Drawer.Portal>
        ...
        <Drawer.Content
          ...
          style={{ backgroundColor: "var(--bg-card)", boxShadow: "var(--shadow-drawer)", maxHeight: "92dvh" }}
        >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {filteredBooks.map((book) => (
                      <button key={book.id}
                        ...
                        className="flex flex-col gap-2 p-3 rounded-[12px] text-left"
                        style={{ backgroundColor: "var(--bg-subtle)" }}>
                        {book.coverUrl ? (
                          <img src={book.coverUrl} alt={book.title} className="w-full aspect-[2/3] object-cover rounded-[8px]" />
                        ) : (
                          <div className="w-full aspect-[2/3] rounded-[8px] flex items-center justify-center"
            ...
            <div className="flex flex-col px-5 py-4 gap-6">
              ...
              <div className="flex flex-col items-center gap-3">
                <input type="number" inputMode="numeric"
                  ...
                  style={{ fontSize: "40px", fontFamily: "var(--font-lora)", fontWeight: 600, color: "var(--text-primary)" }}
                  placeholder="0"
                  value={inputValue}
              ...
              <button onClick={handleSubmit}
                ...
                className="w-full py-3.5 rounded-[10px] font-serif text-base font-semibold text-white disabled:opacity-40 flex items-center justify-center gap-2"
            ...
            <div className="flex flex-col px-5 py-4 gap-6 items-center">
              ...
              <div className="flex items-center gap-4 w-full p-4 rounded-[12px]" style={{ backgroundColor: "var(--bg-subtle)" }}>
                {selectedBook.coverUrl ? (
                  <img src={selectedBook.coverUrl} alt={selectedBook.title} className="w-12 rounded-[6px]" />
                ) : (
